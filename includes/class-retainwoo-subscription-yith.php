<?php
/**
 * RetainWoo YITH Subscriptions Wrapper
 *
 * @package RetainWoo
 */
...
class RetainWoo_Subscription_YITH extends RetainWoo_Subscription_Base {
	...
	public function get_total() {
		return (float) get_post_meta( $this->id, '_ywsbs_price', true );
	}
	...
	public function get_billing_period() {
		$period = get_post_meta( $this->id, '_ywsbs_subscription_period', true );
	...
	public function get_billing_interval() {
		$interval = get_post_meta( $this->id, '_ywsbs_subscription_interval', true );
	...
	public function get_next_payment_date() {
		return get_post_meta( $this->id, '_ywsbs_payment_due_date', true );
	}

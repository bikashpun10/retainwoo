 ...
 * RetainWoo Offers
 *
 * Handles retention offer logic including pause, skip, and discount offers.
 *
 * @package RetainWoo
 */
...
class RetainWoo_Offers {
	...
	/**
	 * Apply a retention offer to a subscription.
	 *
	 * @param RetainWoo_Subscription_Base $sub   Subscription object.
	...
	/**
	 * Check eligibility of all offers for a given subscription.
